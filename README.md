...
## 💻 Abstract Data Structures and Algorithms Used

The table below details the underlying Abstract Data Structures (ADS) and Algorithms supporting each feature:

| Feature | Abstract Data Structure (ADS) | Algorithm |
| :--- | :--- | :--- |
| Dynamic Resource Allocation | Linked List | Traversal and Insertion Algorithm |
| User Action Tracking | Stack | Stack's Push and Pop Operations |
| Staff Directory | Binary Search Tree | BST's Operations |
| Record Retrieval | Hash Table | Hashing and Collision Resolution Algorithm |
| Patient Priority Queue | Queue | Max-Heap Algorithm |
